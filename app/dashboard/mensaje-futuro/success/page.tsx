...
export default async function MensajeFuturoSuccessPage({ searchParams }: SuccessPageProps) {
  ...
  return (
    <div className="flex flex-col items-center pb-16 px-6 pt-10 min-h-screen">
      ...
      <div className="relative flex items-center justify-center mb-6">
        ...
        <div className="flex h-24 w-24 items-center justify-center rounded-3xl border-2 border-border bg-surface/50">
          <div className="relative flex items-center justify-center">
            <Calendar className="h-10 w-10 text-foreground/30" strokeWidth={1} />
            <Lock className="absolute -bottom-1 -right-1 h-4 w-4 text-foreground/50 bg-background rounded-full p-[2px]" strokeWidth={2} />
          </div>
        </div>
        <SparkIcon className="absolute -right-8 top-2 text-2xl opacity-30" />
      </div>
      ...
      <p className="font-sans text-[13px] text-foreground/50 text-center mb-8 leading-relaxed max-w-[280px]">
        Hemos guardado tu mensaje en el calendario y no podrá abrirse hasta la fecha elegida.
        Estará protegido y esperando su momento.
      </p>
      ...
      <div className="w-full rounded-3xl border border-border bg-surface/30 p-5 mb-6 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-foreground/40">Formato</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-foreground/40">Fecha de apertura</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-foreground/40">Estado</p>
            <p className="text-[14px] font-semibold text-foreground">Protegido hasta la fecha elegida</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full rounded-2xl border border-border bg-surface/20 px-5 py-4 mb-10">
        <p className="text-[12px] text-foreground/50 leading-relaxed text-center">
          Lo encontrarás en tu calendario. Ese día aparecerá marcado con un símbolo especial.
          Hasta entonces, seguirá guardado.
        </p>
      </div>
