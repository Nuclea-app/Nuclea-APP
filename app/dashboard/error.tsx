...
export default function DashboardError({
  ...
  return (
    <div className="flex h-full min-h-[60vh] flex-col items-center justify-center p-6 text-center">
      <div className="flex items-center gap-2 font-sans font-bold tracking-[0.3em] uppercase text-xl mb-8">
        NUCLEA <SparkIcon />
      </div>
      
      <h1 className="font-serif text-2xl text-foreground mb-4">Algo salió mal</h1>
      <p className="font-sans text-foreground/40 mb-12">
        No pudimos cargar tu cápsula.
      </p>
