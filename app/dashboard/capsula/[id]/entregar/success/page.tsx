...
export default async function EntregarSuccessPage({
  ...
  return (
    <div className="flex flex-col items-center pb-16 px-6 min-h-screen">
      ...
      {/* Título */}
      <h1 className="font-serif text-4xl leading-tight text-foreground text-center mb-3">
      ...
      <p className="font-sans text-[14px] text-foreground/50 text-center mb-8 leading-relaxed">
        Tu mensaje ya está en camino.<br />
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <div className="flex items-center gap-3 mb-2">
          <div className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-dashed border-foreground/20">
            <SparkIcon className="text-base text-foreground/40" />
          </div>
        ...
        {/* Corazón */}
        <Heart className="h-6 w-6 text-foreground/20 mt-1" strokeWidth={1.5} />
      </div>
      ...
      <div className="w-full rounded-3xl border border-border bg-background shadow-sm overflow-hidden mb-6">
        ...
        {name && (
          <div className="flex items-center gap-4 px-5 py-4">
            ...
            <div>
              <p className="text-[11px] text-foreground/40 mb-0.5">Enviado a:</p>
        ...
        <div className="flex items-center gap-6 px-5 py-4">
          <div className="flex items-center gap-2">
            <Calendar className="h-4 w-4 text-foreground/30" strokeWidth={1.5} />
            <span className="text-[13px] text-foreground/60">{formattedDate}</span>
          </div>
          <div className="h-4 w-px bg-border" />
          <div className="flex items-center gap-2">
            <Clock className="h-4 w-4 text-foreground/30" strokeWidth={1.5} />
            <span className="text-[13px] text-foreground/60">{formattedTime}</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 px-5 py-4">
          ...
          <p className="font-sans text-[13px] text-foreground/50 leading-relaxed italic">
            Lo que hoy envías,<br />
      ...
      <Link
        ...
        className="w-full flex items-center justify-center gap-2 rounded-2xl bg-foreground text-background py-4 text-[13px] font-semibold tracking-wide transition-all active:scale-[0.98] hover:opacity-90 mb-3"
      >
      ...
      <Link
        href="/dashboard"
        className="w-full flex items-center justify-center rounded-2xl border-2 border-foreground/20 text-foreground py-4 text-[13px] font-semibold tracking-wide transition-all active:scale-[0.98] hover:bg-surface"
      >
        Volver al inicio
      </Link>
    </div>
